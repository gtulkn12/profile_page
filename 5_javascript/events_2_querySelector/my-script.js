...
document.querySelector("#random_quote_btn").onclick = function () {
  let newP = document.createElement("p");

  newP.innerHTML = pickRandomQuote(inspirationalQuotes);

  document.querySelector("#quotes_container").prepend(newP);
